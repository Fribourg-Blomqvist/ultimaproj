<?php require 'config/datamanager.php';
...
<body style="background: url(assets/img/bg-recettes.png) no-repeat; background-position-x: 10%;">
    ...
    <nav id="nav">
        ...
        <ul id="menu">
            ...
            <li>
                <a href="producteur.html">Producteurs</a>
            </li>
            <li>
                <a href="crud/formulaire.php">Coté cuisine</a>
            </li>
    ...
    <main class="page-content">
        <div class="contenaire">
            ...
            ?>
                ...
                <div class="carte">
                    <div class="carte2"><img src="assets/img/<?= $row['images'] ?> " alt="photo"></div>
